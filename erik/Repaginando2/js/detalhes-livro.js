        ...
        <section class="book-detail">
            ...
            <div>
                ...
                <div class="d-flex d-row gap-3">
                    <a style="margin-right: 14px;" type="button" class="btn btn-outline-light btn-lg contact-whatsapp" id="contact-whatsapp">
                    <img src="imagens/redes/btn-whatsapp.png">
                    </a>
                    <a type="button" class="btn btn-outline-light btn-lg contact-email" id="contact-email">
